...
Quando faço o cadastro desse item
    ...
    Input Text                      ${CAMPO_PRATO}         ${produto['tipo']}
...
#KWS do cenário receber-pedidos "API"
...
E "${email_cliente}" é o e-mail do meu cliente
...
E que "${produto}" está cadastrado no meu dashboard
    ...
    &{payload}=         Create Dictionary   name=${produto}     plate=NewPrato      price=13.00
